...
exports.getAvailableSlots = exports.createAppointment = void 0;
...
const getAvailableSlots = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const slots = yield appointmentService.getAvailableSlots(String(date), String(service), String(barber));
        res.json(slots);
    }
    catch (error) {
        res.status(400).json({ error: error.message });
